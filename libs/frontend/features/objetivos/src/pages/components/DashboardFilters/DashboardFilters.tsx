/**
 * @biosstel/objetivos - Dashboard Filters
 * Componente de dominio: recibe onFilterChange por props.
 */
...
const FILTER_OPTIONS = {
  ...
  usuarios: [{ value: 'all', label: 'Todos' }],
  familia: [{ value: 'all', label: 'Todos' }],
  subfamilia: [{ value: 'all', label: 'Todos' }],
  productos: [{ value: 'all', label: 'Todos' }],
  estado: [
    { value: 'all', label: 'Todos' },
  ...
  return (
    <div ref={containerRef} className="flex flex-wrap gap-3 mb-8">
      ...
      <div className="relative">
        <button
          onClick={() =>
            setOpenDropdown(openDropdown === 'centrosTrabajo' ? null : 'centrosTrabajo')
          }
          className={`px-4 py-2.5 rounded-lg border text-sm font-medium transition-all ${
      ...
      {['usuarios', 'familia', 'subfamilia', 'productos'].map((key) => (
