...
import { ResumeFichajeCommand } from '../../../commands/fichajes/ResumeFichaje.command';
import type { Fichaje } from '../../../../../domain/entities';
import { type IFichajeRepository, I_FICHAJE_REPOSITORY } from '../../../../../domain/repositories';

@CommandHandler(ResumeFichajeCommand)
@Injectable()
export class ResumeFichajeHandler implements ICommandHandler<ResumeFichajeCommand> {
  constructor(
  ...
  async execute(command: ResumeFichajeCommand): Promise<Fichaje> {
