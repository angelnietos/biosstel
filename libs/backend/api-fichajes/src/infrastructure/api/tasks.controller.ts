...
import { UpdateTaskCommand } from '../../application/commands/UpdateTask.command';
import { DeleteTaskCommand } from '../../application/commands/DeleteTask.command';
import { GetTasksByUserQuery } from '../../application/queries/GetTasksByUser.query';
import { GetTaskByIdQuery } from '../../application/queries/GetTaskById.query';

class CreateTaskDto {
  @IsString()
  @ApiProperty({ type: String, description: 'ID del usuario propietario de la tarea.', example: 'f2ce86c5-0406-403e-a6dc-8a55d91f480b' })
  userId!: string;
  @IsString()
