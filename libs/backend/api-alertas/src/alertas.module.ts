...
import { FichajeEndedAlertHandler } from './application/cqrs/handlers/alertas/FichajeEndedAlert.handler';
import { AlertasMediatorRegistration } from './application/cqrs/AlertasMediatorRegistration';
import { ListAlertasHandler } from './application/cqrs/handlers/alertas/ListAlertas.handler';
